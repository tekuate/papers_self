...
titlef='Tz deep '+title+' kk='+strdigit(kk,4)+' k='+strtrim(k,2)+' lmdc='+strdigit(lamdac,1)
...
if(isave)then  saveimage,'gif/Tz_deep_kk_'+strdigit(kk,3)+title+'_k='+strtrim(k,2)+'_lmdc='+strdigit(lamdac,1)+'.gif'
...
if(isave)then  saveimage,'gif/T_deep_kk_'+strdigit(kk,3)+'_'+title+'.gif'
...
for ic=ncase-1,0,-ncase/2 do begin
 ...
 if(isave)then saveimage,'gif/fluxdeep_kk_'+strdigit(kk,3)+'_'+title+'.gif'

 titled='gif/ddeep_'+strdigit(kk,3)+'_form_'+strtrim(form,2)+'.dat'
 print,titled
